...
export function AuthIcon(props: Props): JSX.Element {
  if (props.variant === "apple.com") {
    return (
  ...
  if (props.variant === "naver.com") {
    return <SvgIcon role="img" viewBox="0 0 24 24"></SvgIcon>;
  }

  if (props.variant === "kakao.com") {
    return (
      <SvgIcon role="img" viewBox="0 0 256 256">
        <path
          fill="#FFE812"
  ...
  return (
    <SvgIcon role="img" viewBox="0 0 32 32">
