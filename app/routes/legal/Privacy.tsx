  ...
  return (
    ...
    >
      <div>
        ...
        <Divider />
        <p>
          {`< 주식회사 심도컴퍼니 >('https://www.aibici.co.kr'이하
          '아비치')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의
          개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수
          있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.`}
        </p>
        <p>○ 이 개인정보처리방침은 2023년 5월 31부터 적용됩니다.</p>
        <p>
          <br />
        </p>
        ...
        <p>
          {`< 주식회사 심도컴퍼니 >('https://www.aibici.co.kr'이하
          '아비치')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고
        ...
        <p>
          ...
          관리&gt;와 관련한 개인정보는 수집.이용에 관한 동의일로부터&lt;가입
          시점으로부터 탈퇴 시까지&gt;까지 위 이용목적을 위하여 보유.이용됩니다.{" "}
        </p>
        <p>보유근거 : 운영서버의 데이터베이스에서 보유여부 확인 관련법령 : </p>
        <p>1)표시/광고에 관한 기록 : 6개월 </p>
        <p>2) 계약 또는 청약철회 등에 관한 기록 : 5년 </p>
        <p>3) 대금결제 및 재화 등의 공급에 관한 기록 : 5년 </p>
        <p>4) 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년 </p>
        <p>5) 신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년 </p>
        <p>
          <br />
        </p>
        <h2>제3조(처리하는 개인정보의 항목)</h2>
        <p>
          ① &lt; 주식회사 심도컴퍼니 &gt;은(는) 다음의 개인정보 항목을 처리하고
          있습니다.{" "}
        </p>
        <p>
          1&lt; 홈페이지 회원가입 및 관리 &gt; 필수항목 : 로그인ID, 비밀번호,
          휴대전화번호, 이메일, 결제기록, 접속 IP 정보, 쿠키, 접속 로그, 서비스
          이용 기록
        </p>
        <p>
          2&lt; 민원사무 처리 &gt; 필수항목 : 이름, 로그인ID, 휴대전화번호,
          이메일, 결제기록, 접속 IP 정보, 쿠키, 접속 로그, 서비스 이용 기록
        </p>
        <p>
          3&lt; 재화 또는 서비스 제공 &gt; 필수항목 : 로그인ID, 이메일,
          은행계좌정보, 신용카드정보, 결제기록, 접속 IP 정보, 쿠키, 접속 로그,
          서비스 이용 기록
        </p>
        <p>
          4&lt; 마케팅 및 광고에의 활용 &gt; 필수항목 : 이름, 로그인ID,
          휴대전화번호, 이메일, 결제기록, 접속 IP 정보, 쿠키, 접속 로그, 서비스
          이용 기록
        </p>
        <p>
        ...
        <p>
          1. 파기절차 &lt; 주식회사 심도컴퍼니 &gt; 은(는) 파기 사유가 발생한
          개인정보를 선정하고, &lt; 주식회사 심도컴퍼니 &gt; 의 개인정보
        ...
        <p>
          ① 정보주체는 주식회사 심도컴퍼니에 대해 언제든지 개인정보
          열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.{" "}
        </p>
        <p>
          ② 제1항에 따른 권리 행사는주식회사 심도컴퍼니에 대해 「개인정보
          보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을
          통하여 하실 수 있으며 주식회사 심도컴퍼니은(는) 이에 대해 지체 없이
          조치하겠습니다.{" "}
        </p>
        <p>
        ...
        <p>
          ⑥ 주식회사 심도컴퍼니은(는) 정보주체 권리에 따른 열람의 요구,
        ...
        <p>
          &lt; 주식회사 심도컴퍼니 &gt;은(는) 개인정보의 안전성 확보를 위해
          다음과 같은 조치를 취하고 있습니다.{" "}
        </p>
        <p>
        ...
        <p>
          3. 정기적인 자체 감사 실시 개인정보 취급 관련 안정성 확보를 위해
        ...
        <p>
          5. 접속기록의 보관 및 위변조 방지 개인정보처리시스템에 접속한 기록을
        ...
        <p>
          ① 주식회사 심도컴퍼니 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기
        ...
        <p>
          &lt; 주식회사 심도컴퍼니 &gt;은(는) 정보주체의 개인정보 열람청구가
          신속하게 처리되도록 노력하겠습니다.{" "}
        </p>
        <p>
          <br />
